            ...
            <div class="text-4xl p-5 text-black text-center">
                ...
                <form class="max-w-sm mx-auto" method="post">
                    <div class="mb-5">
                        ...
                        <input type="text", name="nama_member" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Ghani Mudzakir" required />
                    </div>
                    <div class="mb-5">
                        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nomor Telepon:</label>
                        <input type="text", name="nomor_member" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="08123456789" required />
                    </div>
                    <div class="mb-5">
                ...
                if (isset($_POST['kirim'])) {
                    ...
                    $hasil = tambahDataMember($koneksi,  $nama_member, $nomor_member, $alamat);
                }
                ?>
        </div>
