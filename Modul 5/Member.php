...
<html lang="en">
    <head>
        <meta charset="UTF-8">
        <title>Data Member Perpustakaan Mudzakir</title>
        ...
        <div class="flex flex-row pr-10">
            ...
            <div class="ml-80 mr-9">
                <div class="pt-10 pb-10 pr-10 ">
                    <h1 class="text-4xl">
                        Daftar Member Perpustakaan Mudzakir
                    </h1>
                </div>
                <table class="table-auto w-full border-collapse border border-black">
                        <thead class="bg-gray-400 border border-black">
                            <tr class="text-black">
                                ...
                                <th class="border-collapse border border-black px-5 py-2" colspan="2">
                                    Opsi
                                </th>
                            </tr>
                        </thead>
                    ...
                    $tampilDataMember = TampilDataMember($koneksi);
                    if (isset($_GET['kode'])) {
                        $id = $_GET['kode'];
                        HapusDataMember($koneksi, $id);
