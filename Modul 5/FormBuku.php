...
<html lang="en">
    <head>
            <meta charset="UTF-8">
            <title>Form Tambah Member Perpustakaan Mudzakir</title>
        ...
        <div class="mt-24 mx-auto w-2/4 h-auto">
            ...
            <form class="max-w-sm mx-auto" method="post">
                    <div class="mb-5">
                        ...
                        <input type="text" name="judul_buku" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Negeri Para Bedebah   " required />
                    </div>
                    <div class="mb-5">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text", name="tahun_terbit" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="2012" required />
                    </div>
                    <div class="mb-5">
                        <button name="kirim" class="text-white bg-gray-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Daftar</button>
                    </div>
            </form>
        </div>
    </body>
...
if (isset($_POST['kirim'])) {
    ...
    $hasil = tambahDataBuku($koneksi, $judul_buku, $penulis, $penerbit, $tahun_terbit);
}
?>