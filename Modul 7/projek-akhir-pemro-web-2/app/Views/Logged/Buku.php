...
<?= $this->section('isi_beranda') ?>
    ...
    <div class="flex flex-row font-[Poppins]">
        ...
        <div class="flex flex-col min-h-screen w-full bg-[#00ADB5] text-[#222831]">
            <div class="mt-6 ml-6 mb-6">
                <h1 class="text-3xl font-bold">Lihat Data Buku</h1>
                <div class="bg-white rounded-lg shadow-lg ml-6 mr-12 mt-12 p-6 overflow-auto">
                    ...
                    <div class="mt-4">
                        <a href="<?= base_url('logged/hapus') ?>">
                            <p class="underline hover:text-blue-700 hover:underline">ingin menghapus data buku?</p>
                        </a>
                    </div>
                    <div class="mt-4">
                        <a href="<?= base_url('logged/tambah') ?>">
                            <p class="underline hover:text-blue-700 hover:underline">ingin menambah data buku?</p>
                        </a>
                    </div>
                </div>
            </div>
