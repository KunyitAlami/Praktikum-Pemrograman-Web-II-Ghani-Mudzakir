     ...
     <!-- isi halaman ini -->
        <div class="flex flex-col min-h-screen w-full bg-[#00ADB5]">
            <div class="m-6 min-w-screen ">
                <h1 class="text-[#222831] text-3xl font-bold">Hapus Data Buku</h1>
                <div class="bg-white rounded-lg shadow-lg ml-6 mr-12 mt-12 p-6 overflow-auto">
                        ...
                        <tbody class="bg-white text-[#222831]">
                            ...
                            <tr class="hover:bg-gray-100">
                                ...
                                <td class="py-2 px-4 border-b border-gray-200">
                                    <form action="<?= base_url('logged/Buku/delete/' . $a['id']) ?>" method="post">
                                        <?= csrf_field() ?>
                                        <input type="hidden" name="_method" value="DELETE">
                                        <a>
                                            <button type="submit" class="bg-red-200 rounded-lg px-2.5 py-2 hover:bg-red-500 hover:text-white"
                    ...
                    <div class="mt-4">
                        <a href="<?= base_url('logged/ubah') ?>">
                            <p class="underline hover:text-blue-700 hover:underline">ingin mengubah data buku?</p>
                        </a>
                    </div>
                </div>
            </div>
